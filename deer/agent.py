...
class NeuralAgent(object):
    ...
    def __init__(
        ...
        if test_policy == None:
            self._test_policy = EpsilonGreedyPolicy(
                learning_algo, environment.nActions(), random_state, 0.0
            )
        else:
    ...
    def summarizeTestPerformance(self):
        ...
        self._environment.summarizePerformance(
            self._tmp_dataset, self._learning_algo, train_data_set=self._dataset
        )
    ...
    def _runEpisode(self, maxSteps):
        ...
        while maxSteps > 0:
            ...
            if self.gathering_data == True or self._mode != -1:
                ...
                is_terminal = (
                    self._environment.inTerminalState()
